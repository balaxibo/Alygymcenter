export function formatMoney(amount, includeCurrency) {
  if (typeof includeCurrency === 'undefined') includeCurrency = false;
...
export function setTotalWithMonthCard(pkgPrice, mode) {
  if (typeof mode === 'undefined') mode = 'register';
  let seg = 'chungCu';
